...
def getASD(orderedBars, apply_30_flag, NL_flag, AI=None):
    ...
    for j in [0.7, -0.7]:
        for i in ["EX", "EXP", "EXN"]:
            ...
            if apply_30_flag and ("EY" and "EY" in orderedBars): indx = bars.index(['EY']); bars[indx] = ["EY", "EY"]; vals[indx] = [0.21, -0.21]
            if AI:
        ...
        for i in ["EY", "EYP", "EYN"]:
            ...
            vals = [barsDic[i] for i in orderedBars if i in validBars]    
            if i in orderedBars: indx = bars.index([i]); vals[indx] = [j]   
            if apply_30_flag and ("EX" and "EX" in orderedBars): indx = bars.index(['EX']); bars[indx] = ["EX", "EX"]; vals[indx] = [0.21, -0.21]
            if AI:
                if "EV" in orderedBars: indx = bars.index(['DL']); bars[indx] = ["DL", "DL"]; vals[indx] = [1+AI, 1-AI]; bars.remove(['EV'])
            else:
                if "EV" in orderedBars: indx = bars.index(['EV']); bars[indx] = ["EV", "EV"]; vals[indx] = [0.7, -0.7]
    ...
    if "LLPAR" in orderedBars: indx = bars.index(['LLPAR']); vals[indx] = [0.75]
    if "LLR" in orderedBars: indx = bars.index(['LLR']); vals[indx] = [0.75]        
    if "WXP" and "WYP" in orderedBars: indx = bars.index(['WXP']); bars[indx] = ["WXP", "WYP"]; vals[indx] = [0.63, 0.63]; bars.remove(['WYP'])
    if "Wi+" and "Wi-" in orderedBars: indx = bars.index(['Wi+']); bars[indx] = ["Wi+", "Wi-"]; vals[indx] = [0.63, 0.63]; bars.remove(['Wi-'])
    ...
    for j in [0.525, -0.525]:
        for i in ["EX", "EXP", "EXN"]:
            ...
            if "LLR" in orderedBars: indx = bars.index(['LLR']); vals[indx] = [0.75]
            if i in orderedBars: indx = bars.index([i]); vals[indx] = [j]   
            if apply_30_flag and ("EY" and "EY" in orderedBars): indx = bars.index(['EY']); bars[indx] = ["EY", "EY"]; vals[indx] = [0.1563, -0.1563]
            if AI:
                if "EV" in orderedBars: indx = bars.index(['DL']); bars[indx] = ["DL", "DL"]; vals[indx] = [1+AI, 1-AI]; bars.remove(['EV'])
            else:
        ...
        for i in ["EY", "EYP", "EYN"]:
            ...
            if "LLR" in orderedBars: indx = bars.index(['LLR']); vals[indx] = [0.75]
            if i in orderedBars: indx = bars.index([i]); vals[indx] = [j]   
            if apply_30_flag and ("EX" and "EX" in orderedBars): indx = bars.index(['EX']); bars[indx] = ["EX", "EX"]; vals[indx] = [0.1563, -0.1563]
            if AI:
                if "EV" in orderedBars: indx = bars.index(['DL']); bars[indx] = ["DL", "DL"]; vals[indx] = [1+AI, 1-AI]; bars.remove(['EV'])
            else:
                if "EV" in orderedBars: indx = bars.index(['EV']); bars[indx] = ["EV", "EV"]; vals[indx] = [0.525, -0.525]
    ...
    if "WXP" and "WYP" in orderedBars: indx = bars.index(['WXP']); bars[indx] = ["WXP", "WYP"]; vals[indx] = [0.84, 0.84]; bars.remove(['WYP'])
    if "Wi+" and "Wi-" in orderedBars: indx = bars.index(['Wi+']); bars[indx] = ["Wi+", "Wi-"]; vals[indx] = [0.84, 0.84]; bars.remove(['Wi-'])
    ...
    for j in [0.7, -0.7]:
        for i in ["EX", "EXP", "EXN"]:
            ...
            if apply_30_flag and ("EY" and "EY" in orderedBars): indx = bars.index(['EY']); bars[indx] = ["EY", "EY"]; vals[indx] = [0.21, -0.21]
            if AI:
                if "EV" in orderedBars: indx = bars.index(['DL']); bars[indx] = ["DL", "DL"]; vals[indx] = [0.6+AI, 0.6-AI]; bars.remove(['EV'])
            else:
                if "EV" in orderedBars: indx = bars.index(['EV']); bars[indx] = ["EV", "EV"]; vals[indx] = [0.7, -0.7]
        ...
        for i in ["EY", "EYP", "EYN"]:
            ...
            df = makeCombo(df, product(bars), product(vals), "9")
    # Combo: 10
    validBars = ["DL", "SDL", "WALL", "PS0", "+T30", "-T30"]
    bars = [[i] for i in orderedBars if i in validBars]
    vals = [barsDic[i] for i in orderedBars if i in validBars]      
    if "+T30" in orderedBars: indx = bars.index(['+T30']); bars[indx] = ["+T30", "-T30"]; vals[indx] = [1.0, 1.0]; bars.remove(['-T30'])
    ...
    if "LLPAR" in orderedBars: indx = bars.index(['LLPAR']); vals[indx] = [0.75]
    if "LLR" in orderedBars: indx = bars.index(['LLR']); vals[indx] = [0.75]
    if "+T30" in orderedBars: indx = bars.index(['+T30']); bars[indx] = ["+T30", "-T30"]; vals[indx] = [0.75, 0.75]; bars.remove(['-T30'])
    df = makeCombo(df, product(bars), product(vals), "11")
    # Add Notional Bar
    if NL_flag:
...
def getLRFD(orderedBars, apply_30_flag, NL_flag, AI=None):
    ...
    if "SDL" in orderedBars: indx = bars.index(['SDL']); vals[indx] = [1.2]
    if "WALL" in orderedBars: indx = bars.index(['WALL']); vals[indx] = [1.2]
    if "WXP" and "WYP" in orderedBars: indx = bars.index(['WXP']); bars[indx] = ["WXP", "WYP"]; vals[indx] = [0.7, 0.7]; bars.remove(['WYP'])
    if "Wi+" and "Wi-" in orderedBars: indx = bars.index(['Wi+']); bars[indx] = ["Wi+", "Wi-"]; vals[indx] = [0.7, 0.7]; bars.remove(['Wi-'])
    if "LLR" in orderedBars: indx = bars.index(['LLR']); vals[indx] = [1.6]    
    if "PS0" in orderedBars: indx = bars.index(['PS0']); vals[indx] = [1.6]
    ...
    if "LLPAR" in orderedBars: indx = bars.index(['LLPAR']); vals[indx] = [1]
    if "LLR" in orderedBars: indx = bars.index(['LLR']); vals[indx] = [0.5]        
    if "WXP" and "WYP" in orderedBars: indx = bars.index(['WXP']); bars[indx] = ["WXP", "WYP"]; vals[indx] = [1.4, 1.4]; bars.remove(['WYP'])
    if "Wi+" and "Wi-" in orderedBars: indx = bars.index(['Wi+']); bars[indx] = ["Wi+", "Wi-"]; vals[indx] = [1.4, 1.4]; bars.remove(['Wi-'])
    df = makeCombo(df, product(bars), product(vals), "4")
    # Combo: 5
    for j in [1, -1]:
        for i in ["EX", "EXP", "EXN"]:
